...
async function createIolOsPdf(input, output, i) {
  try {
    ...
    const nombrePaciente = capitalizeFullName(
      dataExcel[i].Paciente.replace(/\n$/, "")
    );
    ...
    firstPage.drawText(
      "Impreso el: " + newDate.toString() + "  a las "+ sumarMinutosAHorario(hora, minutos) + " horas.",
      {
        font: customFont,
        x: 445,
        y: 98,
