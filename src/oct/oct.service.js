...
import { textOct } from "../../assets/constants.js";
import fontkit from "@pdf-lib/fontkit";

//FUNCION PARA CREAR EL PDF DE OCT
export async function octService(
  input,
  output,
  data,
  minutosTopoD,
  ...
  try {
    ...
    const horaD =
      ox == "os"
        ? fechaValidacion.toString() + minutosTopoI
        : fechaValidacion.toString() + minutosTopoD;
    //console.log("HORAD", horaD);
    // console.log("OXXXXX", ox);
    function selectHoraI(ox, fechaValidacion, minutosTopoI) {
      if (ox == "os") {
        return "";
      }
      if (ox == "od") {
      ...
      return fechaValidacion.toString() + minutosTopoI;
    }
    const horaI = selectHoraI(ox, fechaValidacion, minutosTopoI);
    // ox == "os" || "od" ? "" : fechaValidacion.toString() + minutosTopoI;
    // console.log("HORAI", horaD);
    ...
    // console.log("TIPO DE OJO", typeOjo);
    ...
    if (data.SP == "x") {
      ...
      //console.log("HORADAA1" + horaD);
      //console.log("HORAIAA1" + horaI);
      //NOMBRE
      firstPage.drawText(capitalizeFullName(nombrePaciente), {
        x: 106,
        y: 793,
      ...
      //FECHA Y HORA 1
      const hora = ox === "os" ? horaI : horaD;
      //console.log("OXZ", ox);
      //console.log("HORA", horaI);
      firstPage.drawText(
        //fechaValidacion.toString() + " " + hora,
        hora,
        //  " / " +
