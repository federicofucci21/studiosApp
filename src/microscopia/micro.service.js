...
//FUNCION PARA CREAR EL PDF DE MiCROSCOPIA
export async function microService(input, output, data) {
  try {
    ...
    const microOD = data.microOD;
    const microOI = data.microOI;
    ...
    // // OBTENER EDAD DEL PACIENTE
    // const nuevaFecha = cambiarFormatoFechaGuion(fechaNacimiento);
    ...
    //OD
    firstPage.drawText("OD: " + microOD.toString(), {
      x: 71,
      y: 599,
      size: 9.99,
      weight: 700,
    ...
    //OI
    firstPage.drawText("OI: " + microOI.toString(), {
      x: 71,
      y: 579,
      size: 9.99,
      weight: 700,
